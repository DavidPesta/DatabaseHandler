...
<a href="#fetch" class="jumpLink">$dbh->fetch( "select * from soldiers where rank = :rank", [ ":rank" => "General" ] );</a><br>
...
echo "<br>";
?><h2 id="fetch">$dbh->fetch( "select * from soldiers where rank = :rank", [ ":rank" => "General" ] );</h2><?php
$soldiers = $dbh->fetch( "select * from soldiers where rank = :rank", [ ":rank" => "General" ] );
echo "<pre>" . print_r( $soldiers, 1 ) . "</pre>";
...
echo "<br>";
?><h2 id="fetchValue">$dbh->fetch( "soldiers" );</h2>
Fetch everything from the soldiers table.<?php
$soldiers = $dbh->fetch( "soldiers" );
echo "<pre>" . print_r( $soldiers, 1 ) . "</pre>";


echo "<br>";
?><h2 id="fetchValue">$dbh->fetchOne( "soldiers" );</h2>
Fetch just the first record from the soldiers table.<?php
$soldiers = $dbh->fetchOne( "soldiers" );
echo "<pre>" . print_r( $soldiers, 1 ) . "</pre>";
...
echo "<br>";
?><h2 id="fetchValue">$dbh->fetch( "soldiers", [], [ "health" => 156 ] );</h2>
Fetch everything for soldiers that have health of 156.<?php
$soldiers = $dbh->fetch( "soldiers", [], [ "health" => 156 ] );
echo "<pre>" . print_r( $soldiers, 1 ) . "</pre>";


echo "<br>";
?><h2 id="fetchValue">$dbh->fetch( "soldiers", [ "name", "rank" ], [ "health" => 156 ] );</h2>
Fetch the name and rank of the soldier that has health of 156.<?php
$soldiers = $dbh->fetch( "soldiers", [ "name", "rank" ], [ "health" => 156 ] );
echo "<pre>" . print_r( $soldiers, 1 ) . "</pre>";


echo "<br>";
?><h2 id="fetchValue">$dbh->fetch( "soldiers", "name", [ "health" => 156 ] );</h2>
Fetch the name of the soldier that has health of 156.<?php
$soldiers = $dbh->fetch( "soldiers", "name", [ "health" => 156 ] );
echo "<pre>" . print_r( $soldiers, 1 ) . "</pre>";


echo "<br>";
?><h2 id="fetchValue">$dbh->fetchGroup( null, "name", "soldiers", "name", [ "health" => 156 ] );</h2>
Fetch the name of the soldier that has health of 156 with fetchGroup.<?php
$soldiers = $dbh->fetchGroup( null, "name", "soldiers", "name", [ "health" => 156 ] );
echo "<pre>" . print_r( $soldiers, 1 ) . "</pre>";


echo "<br>";
?><h2 id="fetchValue">$dbh->fetchValue( "soldiers", "name", [ 10 ] );</h2>
Fetch the name of the soldier that has the soldierId of 10 with fetchValue.<?php
$soldiers = $dbh->fetchValue( "soldiers", "name", [ 10 ] );
echo "<pre>" . print_r( $soldiers, 1 ) . "</pre>";
